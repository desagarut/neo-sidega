																		...
																		<ol>
																			...
																			<li>Data yang dibutuhkan untuk Impor dengan memenuhi aturan data berikut
																				<div class="timeline-footer row">
																					<a class="btn btn-box btn-info btn-sm  margin" href="<?= base_url()?>assets/import/ATURANDATA.xls"><i class="fa fa-download"></i>Unduh Aturan data</a>
																					<a class="btn btn-box btn-info btn-sm  margin" href="<?= base_url()?>assets/import/ContohFormat.xls" ><i class="fa fa-download"></i>Unduh Contoh Urutan Format</a>
																				</div>
																			</li>
																		</ul>
																	</div>
