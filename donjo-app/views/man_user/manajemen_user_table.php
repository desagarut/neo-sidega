		...
		<div class="row">
			<div class="col-md-12">
					...
					<div class="card-header">
						<a href="<?= site_url('man_user/form')?>" class="btn btn-box btn-success btn-sm "><i class="fa fa-plus"></i> Tambah Pengguna Baru</a>
						<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform','<?=site_url("man_user/delete_all/$p/$o")?>')" class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash-o'></i> Hapus Data Terpilih</a>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-sm-12">
