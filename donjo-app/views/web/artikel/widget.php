...
<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Pengaturan Widget</h5>
		<ul class="breadcrumb">
				...
				<div class="col-md-12">
						...
						<div class="card-header">
							...
							<?php if ($this->CI->cek_hak_akses('h')): ?>
								<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?=site_url("web_widget/delete_all/$p/$o")?>')" class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash-o'></i> Hapus Data Terpilih</a>
							<?php endif; ?>
						</div>
						<div class="card-body">
							<div class="row">
