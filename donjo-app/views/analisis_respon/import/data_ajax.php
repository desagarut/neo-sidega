			...
			<div class="card-body">
				<p>
					...
					<div class="timeline-footer row">
						<a href="<?= site_url()?>analisis_respon/data_unduh/1" class="btn btn-box btn-info btn-sm  margin" wrap target="_blank"><i class="fa fa-download"></i> Form Excel + Isi Data</a>
					</div>
				</p>
				<p>
				Unduh form kosong menampilkan daftar kode untuk setiap kolom.
					<div class="timeline-footer row">
						<a href="<?= site_url()?>analisis_respon/data_unduh/2" class="btn btn-box btn-info btn-sm  margin" wrap target="_blank"><i class="fa fa-download"></i> Form Excel + Kode Data</a>
					</div>
				</p>
			</div>
		</div>
