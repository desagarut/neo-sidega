...
<div class="pcoded-main-container">
  ...
  <div class="page-header">
    <h5 class="m-b-10">Daftar Transportasi Warga</h5>
    <ul class="breadcrumb">
  ...
  <div class="card-header"> <a href="<?= site_url("tawa/form")?>" class="btn btn-box btn-success btn-sm btn-sm "  title="Tambah"> <i class="fa fa-plus"></i> Tambah </a> <a href="#confirm-delete" title="Hapus Data Terpilih" onclick="deleteAllBox('mainform', '<?= site_url("tawa/delete_all/$p/$o")?>')" class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash-o'></i> Hapus Data Terpilih</a> <a href="<?= site_url("first/toko_show")?>" class="btn btn-box btn-primary btn-sm btn-sm " target="_blank"  title="Lihat Toko"> <i class="fa fa-eye"></i> Lihat Halaman Depan </a></div>
  <div class="card-body">
  <div class="row">
  <div class="col-sm-12">
