...
<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Lokasi : <?=$toko['nama']?></h5>
		<ul class="breadcrumb">
			...
			<div class="col-md-12">
                ...
                <div class='modal-body'>
                    ...
                    <div class="modal-footer">
                        <div class='col-xs-12'>
                           <a href="<?= site_url("toko_warga")?>" class="pull-left"> <button type="#" class="btn btn-box btn-primary btn-sm"><i class='fa fa-arrow-left'></i> Kembali</button></a>
