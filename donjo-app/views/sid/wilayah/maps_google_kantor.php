                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Kantor Desa</h5>
                        </div>
                        <ul class="breadcrumb">
                            ...
                            <?php endforeach; ?>
                            <li class="breadcrumb-item"><a href="#!">Kantor <?= $wilayah ?> </a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <form action="<?= $form_action ?>" method="post" id="validasi" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control input-sm col-md-3" name="lat" id="lat" value="<?= $wil_ini['lat'] ?>" /><br />
                                <label class="col-sm-2 col-form-label" for="lang"> Langitude </label>
                                <input type="text" class="form-control input-sm col-md-3" name="lng" id="lng" value="<?= $wil_ini['lng'] ?>" />
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="zoom"> Zoom: </label>
                                <input type="text" class="form-control input-sm col-md-3" width="5px" name="zoom" id="zoom" value="<?= $wil_ini['zoom'] ?>" /><br />
                                <label class="col-sm-2 col-form-label" for="map_tipe"> Tipe Peta </label>
                                <select class="form-control input-sm col-md-3" name="map_tipe" id="map_tipe">
                        ...
                        <div class="card-footer text-right">
                            <a href="<?= site_url('identitas_desa') ?>" class="btn btn-info" title="Kembali"><i class="fa fa-arrow-circle-o-left"></i> Kembali</a>
                            <?php if ($this->CI->cek_hak_akses('h')) : ?>
                                <a href="#" class="btn btn-warning" download="SIDeGa_Lokasi_Wilayah_<?php echo ucwords($desa['nama_desa']) ?>.gpx" id="exportGPX"><i class='fa fa-download'></i> Export ke GPX</a>
