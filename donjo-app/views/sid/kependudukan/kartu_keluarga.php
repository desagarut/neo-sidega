<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Salinan Kartu Keluarga</h5>
		<ul class="breadcrumb">
			...
			<div class="row">
				<div class="col-md-12">
						...
						<div class="card-header">
							<a href="<?= site_url("keluarga/cetak_kk/$id_kk")?>" class="btn btn-box bg-purple btn-sm "  target="_blank"><i class="fa fa-print "></i> Cetak</a>
							<a href="<?= site_url("keluarga/doc_kk/$id_kk")?>" class="btn btn-box bg-navy btn-sm "  target="_blank"><i class="fa fa-download"></i> Unduh</a>
							<a href="<?=site_url("keluarga/anggota/$p/$o/$id_kk")?>" class="btn btn-box btn-info btn-sm btn-sm " title="Rincian Anggota Keluarga">
								<i class="fa fa-arrow-circle-left"></i>Kembali Ke Daftar Anggota Keluarga
							</a>
							<a href="<?=site_url("keluarga")?>" class="btn btn-box btn-info btn-sm btn-sm " title="Kembali Ke Daftar Anggota Keluarga">
