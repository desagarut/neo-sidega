          ...
          <div class="card">
            <div class="card-header">
              <?php if ($this->CI->cek_hak_akses('h')) : ?>
                <a href="<?= site_url("penduduk/dokumen/$penduduk[id]") ?>" class="btn btn-box btn-success btn-sm " title="Manajemen Dokumen Penduduk"><i class="fa fa-book"></i> Manajemen Dokumen</a>
              ...
              <?php endif; ?>
              <a href="<?= site_url("penduduk/clear") ?>" class="btn btn-box btn-info btn-sm btn-sm " title="Kembali Ke Daftar Penduduk"> <i class="fa fa-arrow-circle-left"></i>Kembali Ke Daftar Penduduk </a>
            </div>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-radius wid-100 align-top m-r-15" alt="Foto Penduduk" src="<?= AmbilFoto($penduduk['foto'], '', $penduduk['id_sex']) ?>" />
                ...
                <div class="card">
                  <div class="card-body">
                    <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                      <li class="nav-item"><a class="nav-link active text-uppercase" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Home</a></li>
                      <li class="nav-item"><a class="nav-link text-uppercase" id="dokumen-tab" data-toggle="tab" href="#dokumen" role="tab" aria-controls="dokumen" aria-selected="false">Dokumen</a></li>
                      <li class="nav-item"><a href="#biodata" class="nav-link text-uppercase" id="biodata-tab" data-toggle="tab" role="tab" aria-controls="biodata" aria-selected="false">Biodata</a></li>
                      <!--<li><a href="#keluarga" class="nav-link text-uppercase" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true">Keluarga</a></li>-->
                        <li class="nav-item"><a href="#dokumen" class="nav-link text-uppercase" data-toggle="tab" role="tab" aria-controls="dokumen" aria-selected="false">Dokumen</a></li>
                        <li class="nav-item"><a href="#bantuan" class="nav-link text-uppercase" data-toggle="tab" role="tab" aria-controls="bantuan" aria-selected="false">Bantuan</a></li>
                        <li class="nav-item"><a href="#rumah" class="nav-link text-uppercase" data-toggle="tab" role="tab" aria-controls="rumah" aria-selected="false">Foto Rumah</a></li>
                        <li class="nav-item"><a href="#resume" class="nav-link text-uppercase" data-toggle="tab" role="tab" aria-controls="resume" aria-selected="true">Resume</a></li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                      ...
                      <div class="tab-pane fade show active" id="resume">
                        ...
                        <div class="card">
                          <div class="card-header">
                            <h5 class="card-title"><a href="#">Lokasi Rumah</a> </h5>
                        ...
                        <div class="card">
                          <div class="card-header">
                            <h5 class="card-title"><a href="#">Foto Rumah</a></h5>
                          ...
                          <div class="card-footer" align="right"> <a href="<?= site_url("penduduk/rumah/$penduduk[id]") ?>" class="btn bg-maroon btn-social btn-box	btn-danger btn-sm " title="Hapus Rumah"><i class="fa fa-trash-o"></i>Hapus Rumah</a> <a href="<?= site_url("penduduk/rumah_form/$penduduk[id]") ?>" title="Tambah rumah" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Tambah rumah" class="btn btn-box bg-olive btn-sm "><i class='fa fa-plus'></i>Tambah rumah</a> </div>
                        </div>
                        <div class="card">
                          <div class="card-header">
                            <h5 class="card-title"><a href="#bantuan">Program Bantuan</a></h5>
                        ...
                        <div class="card">
                          <div class="card-header">
                            <h5 class="card-title pull-right"><small>Data Awal : <i class="fa fa-clock-o"></i>
                                <?= tgl_indo2($penduduk['created_at']); ?>
