		...
		<div id="isi_popup_dusun_<?= $key_dusun ?>" style="visibility: hidden;">
			<div id="content">
				...
				<div id="bodyContent">
					...
					<p><center><a href="<?=site_url("load_aparatur_wilayah/$dusun[id_kepala]/1")?>" class="btn btn-box bg-navy btn-sm " data-title="Kepala <?= set_ucwords($wilayah) . $dusun['dusun']?>" data-remote="false" data-toggle="modal" data-target="#modalKecil"><i class="fa fa-user"></i>&nbsp;Kepala <?= set_ucwords($wilayah)?>&nbsp;</a></center></p>
				</div>
			</div>
		</div>
	<?php endforeach; ?>
