		...
		<div id="isi_popup_rt_<?= $key_rt ?>" style="visibility: hidden;">
			<div id="content">
				...
				<div id="bodyContent">
					...
					<p><center><a href="<?= site_url("load_aparatur_wilayah/$rt[id_kepala]/3"); ?>" class="btn btn-box bg-navy btn-sm " data-title="Ketua RT" data-remote="false" data-toggle="modal" data-target="#modalKecil"><i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp;&nbsp;Ketua RT&nbsp;&nbsp;&nbsp;&nbsp;</a></center></p>
				</div>
			</div>
		</div>
	<?php endforeach; ?>
