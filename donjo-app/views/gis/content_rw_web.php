		...
		<div id="isi_popup_rw_<?= $key_rw ?>" style="visibility: hidden;">
			<div id="content">
				...
				<div id="bodyContent">
					...
					<p><center><a href="<?= site_url("load_aparatur_wilayah/$rw[id_kepala]/2"); ?>" class="btn btn-box bg-navy btn-sm " data-title="Ketua RW" data-remote="false" data-toggle="modal" data-target="#modalKecil"><i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp;&nbsp;Ketua RW&nbsp;&nbsp;&nbsp;&nbsp;</a></center></p>
				</div>
			</div>
		</div>
	<?php endforeach; ?>
