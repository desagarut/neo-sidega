		...
		<form id="mainform" name="mainform" action="" method="post">
          ...
          <?php $this->load->view('plan/nav.php')?>
            ...
            <div class="box-header with-border">
							<a href="<?=site_url("point/form")?>" class="btn btn-box btn-success btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  title="Tambah Jenis Lokasi Baru">
								<i class="fa fa-plus"></i>Tambah Jenis Lokasi Baru
            	</a>
							<?php if ($this->CI->cek_hak_akses('h')): ?>
								<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?=site_url("point/delete_all/$p/$o")?>')" class="btn btn-box btn-danger btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block hapus-terpilih"><i class='fa fa-trash-o'></i> Hapus Data Terpilih</a>
							<?php endif; ?>
