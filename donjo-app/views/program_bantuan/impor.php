			...
			<form id="mainform" action="<?= site_url("program_bantuan/impor"); ?>" method="POST" enctype="multipart/form-data">
				<div class="modal-body">
					<div class="form-group">
						...
						<br/>
						<a href="<?= base_url("assets/import/format_impor_program_bantuan.xlsx"); ?>" class="btn btn-box bg-purple btn-sm  text-center"><i class="fa fa-file-excel-o"></i> Contoh Format Impor Program Bantuan</a>
					</div>
				</div>
