...
<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Daftar Dokumen Persyaratan Surat</h5>
		<ul class="breadcrumb">
		...
		<div class="row">
			<div class="col-md-12">
					...
					<div class="card-header">
						...
						<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform','<?=site_url("surat_mohon/delete_all/$p/$o")?>')" class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash-o'></i> Hapus Data Terpilih</a>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-sm-12">
