      ...
      <div class="col-md-12">
        <div class="box box-info">
          ...
          <div class="box-header with-border">
            <a href="<?= site_url('covid19')?>" class="btn btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Data Pemudik</a>
