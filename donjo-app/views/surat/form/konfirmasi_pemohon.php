...
<div class="form-group konfirmasi tdk-permohonan tdk-periksa">
	...
	<div class="col-sm-8">
		<a href="<?= site_url("penduduk/dokumen_list/$individu[id]")?>" class="btn btn-box btn-success btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Daftar Dokumen">
			<i class='fa fa-book'></i> Daftar Dokumen
		</a>
		<a href="<?= site_url("penduduk/dokumen/$individu[id]")?>" class="btn btn-box btn-primary btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" target="_blank">
