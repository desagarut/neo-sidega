<div class="pcoded-main-container">
	...
	<div class="card">
		<form id="mainform" name="mainform" action="" method="post">
            ...
            <div class="card-header">
							<a href="<?=site_url("sms/form_anggota/$grup[nama_grup]")?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Tambah Anggota Group"  class="btn btn-box btn-success btn-sm "><i class='fa fa-plus'></i> Tambah Anggota</a>
							<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?=site_url("sms/delete_all_anggota/$grup[id_grup]")?>')" class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash-o'></i> Hapus Data Terpilih</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-sm-12">
