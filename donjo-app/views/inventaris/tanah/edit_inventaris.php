			...
			<div class="row">
				...
				<div class="col-md-9">
					<div class="box box-info">
						...
						<a href="<?= site_url() ?>inventaris_tanah" class="btn btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Tanah</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
