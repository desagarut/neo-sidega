		...
		<form class="form-horizontal" id="validasi" name="form_tanah" method="post" action="<?= site_url("api_inventaris_tanah/update_mutasi/$main->id"); ?>">
          ...
          <?php	$this->load->view('inventaris/menu_kiri.php')?>
            ...
            <div class="box-header with-border">
						<a href="<?= site_url() ?>inventaris_tanah/mutasi" class="btn btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Mutasi Inventaris Tanah</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
