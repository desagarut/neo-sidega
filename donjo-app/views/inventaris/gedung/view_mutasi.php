	...
	<div class="card">
		<form class="form-horizontal" id="validasi" name="form_gedung" method="post" action="<?= $form_action?>">
            ...
            <div class="box-header with-border">
						<a href="<?= site_url() ?>inventaris_gedung/mutasi" class="btn btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Mutasi Inventaris Gedung Dan Bangunan</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
