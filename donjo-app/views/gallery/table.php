...
<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Daftar Album</h5>
		<ul class="breadcrumb">
	...
	<div class="card">
		<form id="mainform" name="mainform" action="" method="post">
            ...
            <div class="card-header">
							...
							<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?= site_url("gallery/delete_all/$p/$o")?>')" class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash-o'></i> Hapus Data Terpilih</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-sm-12">
